...
//            setRecyclerView()
        ...
        val swipeController = SwipeController(object : SwipeControllerActions() {
            ...
            override fun onLeftClicked(position: Int) {
                if (presenter.exercises[position].userId == null) {
                    ...
                    findNavController().navigate(R.id.action_exercisesListFragment_to_addExerciseFragment, bundle, null)
                }
            }
    ...
    private fun showDeleteConfirmationDialog(position: Int) {
        ...
        val contentText = resources.getString(R.string.deleteExerciseContent)
        context?.let {
            confirmationDialog = ConfirmationDialog(it, title, contentText, this, position, null, true)
