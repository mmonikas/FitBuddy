...
import com.monika.ExercisesPage.*
...
import kotlinx.android.synthetic.main.fragment_workout_add.saveButton
import java.util.*
...
class WorkoutAdd : Fragment(), AddAnotherListener, ExerciseSelectionListener, WorkoutElementAddListener {
    ...
    private fun setDetailsData() {
        meLabel3.text = getString(R.string.editWorkoutLabel)
    ...
    private fun setSaveButtonListener() {
        saveButton.setOnClickListener {
            ...
            val isDataValid = DataValidator.isDataForNewWorkoutValid(workoutToSave)
            if (isDataValid) {
